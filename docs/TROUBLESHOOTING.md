...
**Fix in UI:**
1. Use **"✏️ Edit with AI"** in the left panel
2. Try instructions like: `Change all locations to Brandeis`
3. Export again after confirming changes on the right calendar panel
...
- Prefer shared calendars for repeat schedules to avoid unnecessary extractions
